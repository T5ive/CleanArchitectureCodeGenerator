...
public static class ProjectHelpers
{
	...
	public static Project FindSolutionFolder(this Solution solution, string name)
	{
		return solution.Projects
					   .OfType<Project>()
					   .Where(p => p.IsKind(Constants.vsProjectKindSolutionItems))
					   .FirstOrDefault(p => p.Name == name);
	}
	public static Project FindProject(this Solution solution, string name)
	{
		var list = solution.Projects
						   .OfType<Project>()
						   .Where(p => p.IsKind(Constants.vsProjectItemKindSolutionItems))
						   .FirstOrDefault(p => p.Name == name);
	...
	private static Project GetProject(IEnumerable<Project> projects, string name)
	{
		foreach (Project project in projects)
		{
			...
			if (project.Kind is ProjectKinds.vsProjectKindSolutionFolder)
			{
	...
	{
		return kindGuids.Any(guid => projectItem.Kind.Equals(guid, StringComparison.OrdinalIgnoreCase));
	}
